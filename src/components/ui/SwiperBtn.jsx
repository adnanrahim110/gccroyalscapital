...
const SwiperBtn = ({ direction, onClick, w_h, bg }) => {
  ...
  return (
    <div
      ...
      } border-1 border-white text-white rounded-full inline-flex items-center justify-center w-[38px] h-[38px] transition-all duration-200 ease-[cubic-bezier(0.42,0,0.58,1)] z-[1] top-1/2 max-lg:-translate-y-1/2 lg:top-full lg:mt-10 2xl:mt-0 2xl:top-[50%] 2xl:-translate-y-[50%] cursor-pointer ${
        isPrev
