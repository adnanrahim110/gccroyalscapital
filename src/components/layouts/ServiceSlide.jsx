...
function ServiceSlide({ service }) {
  ...
  return (
    <div className="flex flex-col-reverse bg-white/10 text-start justify-start p-2.5 rounded-[20px] h-full transition-all duration-300 ease-in-out backdrop-blur-[10px]">
